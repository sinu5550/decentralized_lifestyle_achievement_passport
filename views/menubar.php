<nav class="sidebar">
  ...
  <div class="mentuItems">
    ...
    <a href="../views/profilemanagement.php"><img
    ...
    <a href="../views/document.php"><img
        src="../assets/menuImages/notification.png"
        alt=""
    ...
    <a href="../views/document.php"><img src="../assets/menuImages/heart.png" alt="" class="icons" />Social
      Impact</a>
    <a href="../views/document.php"><img
        src="../assets/menuImages/file.png"
        alt=""
        class="icons" />Documents</a>
    <a href="../views/community.php"><img
